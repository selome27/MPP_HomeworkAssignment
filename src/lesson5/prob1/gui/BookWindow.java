...
public class BookWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			...
			try{
				RuleSet rules = RuleSetFactory.map.get(BookWindow.this);
				rules.applyRules(BookWindow.this);
				JOptionPane.showMessageDialog(BookWindow.this, "All rules Passed!");
			} catch (RuleException e) {
				JOptionPane.showMessageDialog(BookWindow.this, e.getMessage(), "Rule Error", JOptionPane.ERROR_MESSAGE);
			} catch (Exception e) {
				JOptionPane.showMessageDialog(BookWindow.this, "Still need to check book rules! " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
