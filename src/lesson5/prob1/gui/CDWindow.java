...
public class CDWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		private CDWindow window;
		public ButtonListener(CDWindow window) {
			this.window = window;
		}
		public void actionPerformed(ActionEvent evt){
		//	JOptionPane.showMessageDialog(CDWindow.this, "Still need to check CD rules!");
			try {
				// Get the rules for this window and apply them
				RuleSetFactory.map.get(window.getClass()).applyRules(window);
				JOptionPane.showMessageDialog(window, "All rules Passed!");
			} catch (RuleException e) {
				JOptionPane.showMessageDialog(window, e.getMessage(), "Rule Error", JOptionPane.ERROR_MESSAGE);
			} catch (Exception e) {
				JOptionPane.showMessageDialog(window, "Still need to check CD rules! " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
